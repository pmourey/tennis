...
class Config:
    ...
    CLUBS = [{'id': '62060107', 'active': True, 'name': 'US CAGNES TENNIS', 'city': 'Cagnes-sur-Mer', 'csvfile': 'us_cagnes_tennis'},
             ...
             {'id': '62060449', 'active': False, 'name': 'TC CANNES MONFLEURY', 'city': 'Cannes', 'csvfile': 'tc_cannes_montfleury'},
             ...
             {'id': '62130054', 'active': True, 'name': 'TENNIS CLUB PORT-DE-BOUC', 'city': 'PORT-DE-BOUC', 'csvfile': 'tc_port_de_bouc'},
