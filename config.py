...
class Config:
    ...
    CLUBS = [{'id': '62060107', 'active': True, 'name': 'US CAGNES TENNIS', 'city': 'Cagnes-sur-Mer', 'csvfile': 'us_cagnes_tennis'},
             ...
             {'id': '62060137', 'active': True, 'name': 'ASLM TENNIS CANNES', 'city': 'Cannes', 'csvfile': 'aslm_tennis_cannes'},
             ...
             {'id': '62130274', 'active': True, 'name': 'TENNIS CLUB DE GEMENOS', 'city': 'GEMENOS', 'csvfile': 'tc_gemenos'},
             {'id': '62060022', 'active': False, 'name': 'TC NICE GIORDAN', 'city': 'NICE', 'csvfile': 'tc_nice_giordan'},
             {'id': '62060005', 'active': True, 'name': 'TC BEAULIEU', 'city': 'BEAULIEU', 'csvfile': 'tc_beaulieu'},
             {'id': '57750283', 'active': False, 'name': 'CA VINCENNES', 'city': 'VINCENNES', 'csvfile': 'ca_vincennes'},
             {'id': '62840074', 'active': True, 'name': 'TENNIS CLUB DE BOLLENE', 'city': 'BOLLENE', 'csvfile': 'tc_bollene'},
             {'id': '62130283', 'active': True, 'name': 'T.C PELISSANNAIS', 'city': 'PELISSANNE', 'csvfile': 'tc_pelissannais'},
             {'id': '62130601', 'active': True, 'name': 'TENNIS ACADEMY DE LUMINY', 'city': 'MARSEILLE', 'csvfile': 'ta_luminy'},
